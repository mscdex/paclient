...
PAClient.prototype.setSinkInputMute = function(index, muted, cb) {
  if (typeof index !== 'number' || index < 0 || index > 0xFFFFFFFE)
    throw new Error('Invalid sink input index');
  else if (typeof muted !== 'boolean')
    throw new Error('Muted argument must be a boolean');
...
PAClient.prototype.setSourceOutputMute = function(index, muted, cb) {
  if (typeof index !== 'number' || index < 0 || index > 0xFFFFFFFE)
    throw new Error('Invalid source output index');
  else if (typeof muted !== 'boolean')
    throw new Error('Muted argument must be a boolean');
...
PAClient.prototype.setDefaultSink = function(name, cb) {
  if (typeof name !== 'string')
...
PAClient.prototype.setDefaultSource = function(name, cb) {
  if (typeof name !== 'string')
...
PAClient.prototype.killClient = function(index, cb) {
  if (typeof index !== 'number' || index < 0 || index > 0xFFFFFFFE)
    throw new Error('Invalid client index');
  if (this._index === -1)
    throw new Error('Not ready');
...
PAClient.prototype.killSinkInput = function(index, cb) {
  if (typeof index !== 'number' || index < 0 || index > 0xFFFFFFFE)
    throw new Error('Invalid sink input index');
  if (this._index === -1)
    throw new Error('Not ready');
...
PAClient.prototype.killSourceOutput = function(index, cb) {
  if (typeof index !== 'number' || index < 0 || index > 0xFFFFFFFE)
    throw new Error('Invalid source output index');
  if (this._index === -1)
    throw new Error('Not ready');
